...
[![crates.io](https://img.shields.io/crates/v/serde_styx.svg)](https://crates.io/crates/serde_styx)
[![documentation](https://docs.rs/serde_styx/badge.svg)](https://docs.rs/serde_styx)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/serde_styx.svg)](./LICENSE)

[Serde](https://serde.rs) support for the [Styx](https://github.com/bearcove/styx) configuration language. Deserialize Styx documents using serde's derive macros.
