...
[![crates.io](https://img.shields.io/crates/v/styx-ffi.svg)](https://crates.io/crates/styx-ffi)
[![documentation](https://docs.rs/styx-ffi/badge.svg)](https://docs.rs/styx-ffi)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-ffi.svg)](./LICENSE)

C FFI bindings for the [Styx](https://github.com/bearcove/styx) configuration language. Allows using Styx from C, C++, and other languages with C interop.
