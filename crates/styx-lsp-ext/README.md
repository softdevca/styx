...
[![crates.io](https://img.shields.io/crates/v/styx-lsp-ext.svg)](https://crates.io/crates/styx-lsp-ext)
[![documentation](https://docs.rs/styx-lsp-ext/badge.svg)](https://docs.rs/styx-lsp-ext)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-lsp-ext.svg)](./LICENSE)

Protocol types for [Styx](https://github.com/bearcove/styx) LSP extensions. Defines the RPC interface between the language server and editor extensions.
