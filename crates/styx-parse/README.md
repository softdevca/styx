...
[![crates.io](https://img.shields.io/crates/v/styx-parse.svg)](https://crates.io/crates/styx-parse)
[![documentation](https://docs.rs/styx-parse/badge.svg)](https://docs.rs/styx-parse)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-parse.svg)](./LICENSE)

Event-based parser for the [Styx](https://github.com/bearcove/styx) configuration language. This crate provides low-level parsing primitives that other Styx crates build upon.
