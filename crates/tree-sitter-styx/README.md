...
[![crates.io](https://img.shields.io/crates/v/tree-sitter-styx.svg)](https://crates.io/crates/tree-sitter-styx)
[![documentation](https://docs.rs/tree-sitter-styx/badge.svg)](https://docs.rs/tree-sitter-styx)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/tree-sitter-styx.svg)](./LICENSE)

Tree-sitter grammar for the [Styx](https://github.com/bearcove/styx) configuration language. Enables syntax highlighting, code folding, and structural editing in editors that support tree-sitter.
