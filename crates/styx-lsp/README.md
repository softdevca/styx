...
[![crates.io](https://img.shields.io/crates/v/styx-lsp.svg)](https://crates.io/crates/styx-lsp)
[![documentation](https://docs.rs/styx-lsp/badge.svg)](https://docs.rs/styx-lsp)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-lsp.svg)](./LICENSE)

Language server for the [Styx](https://github.com/bearcove/styx) configuration language. Provides IDE features like diagnostics, completions, hover information, and formatting.
