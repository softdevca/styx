...
[![crates.io](https://img.shields.io/crates/v/styx-format.svg)](https://crates.io/crates/styx-format)
[![documentation](https://docs.rs/styx-format/badge.svg)](https://docs.rs/styx-format)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-format.svg)](./LICENSE)

Core formatting and parsing utilities for the [Styx](https://github.com/bearcove/styx) configuration language. Handles document parsing, validation, and pretty-printing.
