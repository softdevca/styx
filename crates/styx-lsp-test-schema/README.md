...
[![crates.io](https://img.shields.io/crates/v/styx-lsp-test-schema.svg)](https://crates.io/crates/styx-lsp-test-schema)
[![documentation](https://docs.rs/styx-lsp-test-schema/badge.svg)](https://docs.rs/styx-lsp-test-schema)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-lsp-test-schema.svg)](./LICENSE)

Schema types for [Styx](https://github.com/bearcove/styx) LSP extension test files. Internal crate used for testing the language server.
