...
[![crates.io](https://img.shields.io/crates/v/styx-tree.svg)](https://crates.io/crates/styx-tree)
[![documentation](https://docs.rs/styx-tree/badge.svg)](https://docs.rs/styx-tree)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-tree.svg)](./LICENSE)

High-level syntax tree for the [Styx](https://github.com/bearcove/styx) configuration language. Provides a convenient API for working with parsed Styx documents.
