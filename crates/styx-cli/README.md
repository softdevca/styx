...
[![crates.io](https://img.shields.io/crates/v/styx-cli.svg)](https://crates.io/crates/styx-cli)
[![documentation](https://docs.rs/styx-cli/badge.svg)](https://docs.rs/styx-cli)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-cli.svg)](./LICENSE)

Command-line interface for the [Styx](https://github.com/bearcove/styx) configuration language. Provides tools for validation, formatting, schema generation, and language server integration.
