...
[![crates.io](https://img.shields.io/crates/v/styx-embed-macros.svg)](https://crates.io/crates/styx-embed-macros)
[![documentation](https://docs.rs/styx-embed-macros/badge.svg)](https://docs.rs/styx-embed-macros)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-embed-macros.svg)](./LICENSE)

Proc macros for embedding [Styx](https://github.com/bearcove/styx) schemas in binaries. Used by `styx-embed` to compress and embed schema data at compile time.
