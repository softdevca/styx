...
[![crates.io](https://img.shields.io/crates/v/styx-tokenizer.svg)](https://crates.io/crates/styx-tokenizer)
[![documentation](https://docs.rs/styx-tokenizer/badge.svg)](https://docs.rs/styx-tokenizer)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-tokenizer.svg)](./LICENSE)

Tokenizer for the styx language, used by styx-parse and styx-cst.
