...
[![crates.io](https://img.shields.io/crates/v/styx-compat-tests.svg)](https://crates.io/crates/styx-compat-tests)
[![documentation](https://docs.rs/styx-compat-tests/badge.svg)](https://docs.rs/styx-compat-tests)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/styx-compat-tests.svg)](./LICENSE)

Cross-compatibility tests between [facet-styx](../facet-styx) and [serde_styx](../serde_styx). Verifies that both libraries produce identical output and can parse each other's output correctly.
